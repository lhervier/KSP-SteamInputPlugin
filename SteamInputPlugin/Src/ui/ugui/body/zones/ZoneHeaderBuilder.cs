...
namespace com.github.lhervier.ksp.steaminput.ui.ugui.body.zones
{
    ...
    /// </summary>
    public class ZoneHeaderBuilder : IUGUIBuilder<ZoneHeaderController>
    {
        // =====================================
        // Builder Parameters
        // =====================================
        ...
        public ZoneHeaderBuilder WithViewModel(CheatSheetViewModel viewModel)
        {
        ...
        public ZoneHeaderBuilder WithZone(UIPhysicalZone zone)
        {
            this._zone = zone;
            return this;
        }
