...
{
    public class SpaceCenterActionSet : MonoBehaviour, IKspActionSet {
        ...
        public RefreshType Active() {
            ...
            if( SteamControllerPlugin.SpaceCenterBuilding != SpacePortFacility.None ) return RefreshType.Nope;
