...
{
    public class AstronautComplexActionSet : MonoBehaviour, IKspActionSet {
        ...
        public RefreshType Active() {
            ...
            if( SteamControllerPlugin.SpaceCenterBuilding != SpacePortFacility.AstronautComplex ) return RefreshType.Nope;
