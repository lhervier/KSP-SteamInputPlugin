...
{
    public class AdministrationBuildingActionSet : MonoBehaviour, IKspActionSet {
        ...
        public RefreshType Active() {
            ...
            if( SteamControllerPlugin.SpaceCenterBuilding != SpacePortFacility.Administration ) return RefreshType.Nope;
